namespace WinFormLab
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      TreeNode treeNode9 = new TreeNode("DemoForm01");
      TreeNode treeNode10 = new TreeNode("節點12");
      TreeNode treeNode11 = new TreeNode("節點13");
      TreeNode treeNode12 = new TreeNode("DemoSys", new TreeNode[] { treeNode9, treeNode10, treeNode11 });
      ...
      treeNode9.Name = "nodeDemoForm01";
      treeNode9.Tag = "DemoSysUI.DeomForm01, DemoSysUI";
      treeNode9.Text = "DemoForm01";
      treeNode10.Name = "節點12";
      treeNode10.Text = "節點12";
      treeNode11.Name = "節點13";
      treeNode11.Text = "節點13";
      treeNode12.Name = "節點1";
      treeNode12.Text = "DemoSys";
      treeNode13.Name = "節點6";
      treeNode13.Text = "節點6";
